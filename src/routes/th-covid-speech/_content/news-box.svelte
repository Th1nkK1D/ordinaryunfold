...
<div class="rounded-lg p-4 md:p-6 space-x-2 bg-light-blue-50 flex flex-row">
	<div>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-light-blue-600 w-8">
