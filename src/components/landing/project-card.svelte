...
>
	...
	<div class="flex-1 space-y-2 bg-gray-100 p-5 text-gray-900">
		<div class="flex flex-row text-xs text-gray-500 md:text-sm">
			<div class="flex-1">{date}</div>
			<div class="flex flex-row">
				<svg viewBox="0 0 24 24" class="mr-1 h-4 w-4 fill-gray-400">
		...
		<h1 class="font-head font-bold !leading-none md:text-xl">{title}</h1>
